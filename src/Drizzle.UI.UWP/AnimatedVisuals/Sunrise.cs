...
//       
//       Command:
//           LottieGen -Language CSharp -Public -WinUIVersion 2.4 -InputFile sunrise.json
//       
//       Input file:
//           sunrise.json (5269 bytes created 22:25+05:30 Aug 19 2023)
//       
//       LottieGen source:
//           http://aka.ms/Lottie
//
...
namespace Drizzle.UI.UWP.AnimatedVisuals
{
        ...
        : Microsoft.UI.Xaml.Controls.IAnimatedVisualSource
    {
        ...
        public Microsoft.UI.Xaml.Controls.IAnimatedVisual TryCreateAnimatedVisual(Compositor compositor, out object diagnostics)
        {
            ...
            if (Sunrise_AnimatedVisual_UAPv8.IsRuntimeCompatible())
            {
                var res = 
                    new Sunrise_AnimatedVisual_UAPv8(
                        compositor
                        );
                    return res;
            }

            if (Sunrise_AnimatedVisual_UAPv7.IsRuntimeCompatible())
            {
                var res = 
                    new Sunrise_AnimatedVisual_UAPv7(
                        compositor
                        );
                    return res;
            }
        ...
        sealed class Sunrise_AnimatedVisual_UAPv8 : Microsoft.UI.Xaml.Controls.IAnimatedVisual
        {
            ...
            CanvasGeometry Geometry_10()
            {
                ...
                using (var builder = new CanvasPathBuilder(null))
                {
                    builder.BeginFigure(new Vector2(256F, 14F));
                    builder.AddLine(new Vector2(48F, 14F));
                    builder.AddLine(new Vector2(12.1359997F, -17.3810005F));
                    builder.AddCubicBezier(new Vector2(5.1869998F, -23.4610004F), new Vector2(-5.1869998F, -23.4610004F), new Vector2(-12.1359997F, -17.3810005F));
                    builder.AddLine(new Vector2(-48F, 14F));
                    builder.AddLine(new Vector2(-256F, 14F));
                    builder.AddLine(new Vector2(-256F, -292F));
                    builder.AddLine(new Vector2(256F, -292F));
                    builder.AddLine(new Vector2(256F, 14F));
                    builder.EndFigure(CanvasFigureLoop.Closed);
                    result = CanvasGeometry.CreatePath(builder);
            ...
            {
                // Offset:<256, 314>
                var result = CreateSpriteShape(PathGeometry_3(), new Matrix3x2(1F, 0F, 0F, 1F, 256F, 314F));;
            ...
            internal Sunrise_AnimatedVisual_UAPv8(
        ...
        sealed class Sunrise_AnimatedVisual_UAPv7 : Microsoft.UI.Xaml.Controls.IAnimatedVisual
        {
            const long c_durationTicks = 60000000;
            readonly Compositor _c;
            readonly ExpressionAnimation _reusableExpressionAnimation;
            ...
            {
                // Offset:<256, 314>
                var result = CreateSpriteShape(PathGeometry_2(), new Matrix3x2(1F, 0F, 0F, 1F, 256F, 314F));;
                result.StrokeBrush = ColorBrush_AlmostDarkSlateGray_FF374151();
                result.StrokeDashCap = CompositionStrokeCap.Round;
                result.StrokeStartCap = CompositionStrokeCap.Round;
                result.StrokeEndCap = CompositionStrokeCap.Round;
            ...
            internal Sunrise_AnimatedVisual_UAPv7(
                Compositor compositor
                )
            {
                _c = compositor;
