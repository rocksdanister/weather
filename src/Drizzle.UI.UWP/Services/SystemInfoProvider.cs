...
// Based on: https://github.com/CommunityToolkit/WindowsCommunityToolkit/blob/main/Microsoft.Toolkit.Uwp/Helpers/SystemInformation.cs
...
public class SystemInfoProvider : ISystemInfoProvider
{
    ...
    public Version AppVersion => PackageVersionToVersion(ApplicationVersion);

    public string AppName => ApplicationName;

    public bool IsDesktop => AnalyticsInfo.VersionInfo.DeviceFamily == "Windows.Desktop";

    public bool IsTenFoot => AnalyticsInfo.VersionInfo.DeviceFamily == "Windows.Xbox";
    ...
    private static Version PackageVersionToVersion(PackageVersion packageVersion)
    {
