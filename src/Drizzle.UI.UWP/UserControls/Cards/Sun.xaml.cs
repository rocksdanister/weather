...
public sealed partial class Sun : UserControl
{
    ...
    public static readonly DependencyProperty SunriseProperty =
        DependencyProperty.Register("Sunrise", typeof(DateTime?), typeof(Sun), new PropertyMetadata(DateTime.Today.AddHours(6)));
    ...
    public static readonly DependencyProperty SunsetProperty =
        DependencyProperty.Register("Sunset", typeof(DateTime?), typeof(Sun), new PropertyMetadata(DateTime.Today.AddHours(18)));
    ...
    private void Update()
    {
        ...
        var offsetX = x - SunAnimation.ActualWidth / 2;
        var offsetY = y + SunAnimation.ActualHeight / 2;
